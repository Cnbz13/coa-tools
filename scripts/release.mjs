...
const packages = [
  ...
  { name: 'CoA Primalist Helper', component: 'primalist-helper', contentVersion: '1.0.0', platform: 'any', arch: 'any', targetFolder: 'CoAPrimalistHelper', installPath: 'Interface/AddOns', file: 'CoAPrimalistHelper-v1.0.0.zip', source: path.resolve('addons', 'CoAPrimalistHelper', '..'), only: 'CoAPrimalistHelper' },
