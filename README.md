...
La fenêtre est organisée comme un petit parcours : **Comprendre** présente l’identité de la spécialisation, sa ressource, sa boucle actuelle et un objectif adapté à la tranche de niveau ; **Rotation** donne l’ordre des sorts avec une explication courte de chaque transition ; **Situations** sépare l’ouverture, le passage ST/AOE, la gestion de ressource et les soins, défensifs ou contrôles réactifs ; **Sources** explique l’origine et la fraîcheur des conseils. Le but est de guider aussi bien un personnage niveau 10 qu’un personnage avancé sans lui montrer des techniques qu’il n’a pas encore apprises.
