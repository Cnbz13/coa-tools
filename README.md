...
- `CoAHereticHelper-v3.8.1.zip` : HUD visuel compact dédié au Cultist Heretic heal, avec panneau déplaçable, proc de Soin occulte, raccourci et couverture Sang noir membre par membre ;
