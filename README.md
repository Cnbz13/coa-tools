...
Chaque release publie cinq ZIP :
...
- `GridCoA-vX.Y.Z.zip` : chargeur léger dépendant du véritable Grid ; il réactive les types dissipables et affiche aussi les contrôles CoA sans type.
