...
const packages = [
  ...
  { name: 'CoA Heretic Helper', component: 'heretic-helper', contentVersion: '3.8.0', platform: 'any', arch: 'any', targetFolder: 'CoAHereticHelper', installPath: 'Interface/AddOns', file: 'CoAHereticHelper-v3.8.0.zip', source: path.resolve('addons', 'CoAHereticHelper', '..'), only: 'CoAHereticHelper' },
